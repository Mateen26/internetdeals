        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-8 text-surface-700">
            <p className="text-base leading-relaxed">
              At {SITE_NAME}, accessible from https://internetdealz.com/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by {SITE_NAME} and how we use it.
            </p>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">Consent</h2>
            <p className="text-base leading-relaxed">
              By using our website, you hereby consent to our Privacy Policy and agree to its terms.
            </p>

            <h2 className="text-2xl font-bold text-surface-900 mt-12">Information we collect</h2>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">How we use your information</h2>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">Log Files</h2>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">Advertising Partners Privacy Policies</h2>
            <p className="text-base leading-relaxed">
              You may consult this list to find the Privacy Policy for each of the advertising partners of {SITE_NAME}.
            </p>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">Third Party Privacy Policies</h2>
            <p className="text-base leading-relaxed">
              {SITE_NAME} Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.
            </p>
            <p className="text-base leading-relaxed">
              You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers&apos; respective websites.
            </p>

            <h2 className="text-2xl font-bold text-surface-900 mt-12">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">GDPR Data Protection Rights</h2>
            <p className="text-base leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-surface-900 mt-12">Children&apos;s Information</h2>
            <p className="text-base leading-relaxed">
